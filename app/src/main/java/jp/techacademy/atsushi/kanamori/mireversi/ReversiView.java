package jp.techacademy.atsushi.kanamori.mireversi;

import java.util.List;

import jp.techacademy.atsushi.kanamori.mireversi.model.Board;
import jp.techacademy.atsushi.kanamori.mireversi.model.Cell;
...
public class ReversiView extends View {
    ...
    public ReversiView(Context context) {
        ...
        mPaintScreenBg.setColor(ContextCompat.getColor(context, R.color.screen_bg));
        mPaintBoardBg.setColor(ContextCompat.getColor(context, R.color.board_bg));
        mPaintBoardBorder.setColor(ContextCompat.getColor(context, R.color.board_border));
        mPaintCellFgB.setColor(ContextCompat.getColor(context, R.color.cell_fg_black));
        mPaintCellFgW.setColor(ContextCompat.getColor(context, R.color.cell_fg_white));
        mPaintCellAvB.setColor(ContextCompat.getColor(context, R.color.cell_fg_black));
        mPaintCellAvW.setColor(ContextCompat.getColor(context, R.color.cell_fg_white));
        mPaintTextFg.setColor(ContextCompat.getColor(context, R.color.text_fg));
        mPaintTurnRect.setColor(ContextCompat.getColor(context, R.color.turn_rect));
